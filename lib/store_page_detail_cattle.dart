...
void main() {
  runApp(StoreDetailCattlesPage());
}

class StoreDetailCattlesPage extends StatelessWidget {
  const StoreDetailCattlesPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: storeDetail_cattles_widget(),
    );
  }
}

class storeDetail_cattles_widget extends StatefulWidget {
  storeDetail_cattles_widget({Key? key}) : super(key: key);

  @override
  State<storeDetail_cattles_widget> createState() =>
      _storeDetail_cattles_widgetState();
}

class _storeDetail_cattles_widgetState
    extends State<storeDetail_cattles_widget> {
