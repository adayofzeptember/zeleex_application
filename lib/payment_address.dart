...
class PaymentAddressPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: PaymentAddress_widget(),
    );
  }
}

class PaymentAddress_widget extends StatefulWidget {
  PaymentAddress_widget({Key? key}) : super(key: key);

  @override
  State<PaymentAddress_widget> createState() => _PaymentAddress_widgetState();
}

class _PaymentAddress_widgetState extends State<PaymentAddress_widget> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: ThemeData(
