...
class Payment_widget extends StatefulWidget {
  Payment_widget({Key? key}) : super(key: key);

  @override
  State<Payment_widget> createState() => _Payment_widgetState();
}

enum SingingCharacter { lafayette, jefferson }

class _Payment_widgetState extends State<Payment_widget> {
