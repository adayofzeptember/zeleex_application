...
class Order_wait_Detail extends StatefulWidget {
  ...
  @override
  State<Order_wait_Detail> createState() => _Order_wait_DetailState();
}

class _Order_wait_DetailState extends State<Order_wait_Detail> {
  @override
